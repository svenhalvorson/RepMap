...
write.csv(x = pop_table2, file =  "C:/Users/shalvorson/Documents/R files/representation/representation_data2.csv", row.names = FALSE)

# original ----------------------------------------------------------------

# clean up the names and write
colnames(pop_table) = c("State", "State Abbr", "Year", 
                        "State Population", "US Population",
                        "Slave Population", "US Slave Population",
                        "House Representatives", "Total Representatives",
                        "Senators", "Total Senators")

write.csv(x = pop_table, file =  "C:/Users/shalvorson/Documents/R files/representation/representation_data.csv", row.names = FALSE)
